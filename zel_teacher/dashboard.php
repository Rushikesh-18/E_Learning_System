...
//Colunt end user
$sql = "SELECT * FROM classrooms WHERE cr_status=1 AND uid=$user_id";
$query = $conn->query($sql);
$countclassrooms = $query->num_rows;
//Colunt total photos
$sql = "SELECT * FROM assignment WHERE ass_status=1 AND uid=$user_id";
$query = $conn->query($sql);
$countassignment = $query->num_rows;
//count todays compliants
$sql = "SELECT * FROM meet WHERE meet_status=1 AND meet_date='$today' AND uid=$user_id";
$query = $conn->query($sql);
$todaysmeets = $query->num_rows;
//count todays compliants
$sql = "SELECT * FROM assignment WHERE ass_status=1 AND ass_date='$today' AND uid=$user_id";
$query = $conn->query($sql);
$todaysassignments = $query->num_rows;
//count todays compliants
$sql = "SELECT * FROM classrooms WHERE cr_status=1 AND cr_regdate='$today' AND uid=$user_id";
$query = $conn->query($sql);
